function Fk = nufft2_type1(xj, cj, ms, sign, varargin)
% 
% nufft2_type1
% 
% Description
...
% Synthax
% -------
% Fk = nufft2_type1(xj, cj, ms, -1)
% Fk = nufft2_type1(xj, cj, ms, -1, 'double')
% Fk = nufft2_type1(xj, cj, ms, +1, 1e-6)
%      
% Parameters
% ----------
% xj: 2D-matrix [nj, 2]
...
%     regular Cartesian lattice, with the first dimension being x and second
%     dimension being y.
% 
...
%% call NUFFT
Fk = nufft2d1_mex(xj(:, 1), xj(:, 2), cj, sign, eps, ms(1), ms(2));
